...
import static com.example.tannerknabe.budgetapp_v3.enterBudget.MY_PREFS_NAME;
...
public class Categories extends AppCompatActivity {
    ...
    //change to page four
        ...
        String[] percent_array = {perc1,perc2,perc3,perc4,perc5,perc6,perc7,perc8,perc9,perc10};
        //saves all variables to saved preferences
        SharedPreferences.Editor editor = getSharedPreferences(MY_PREFS_NAME, MODE_PRIVATE).edit();
        editor.putInt("numCat", numCat);
        for(int i = 0; i <= numCat; i++) {
            editor.putString("name"+Integer.toString(i), name_array[i]);
            editor.putString("perc"+Integer.toString(i), percent_array[i]);
        }
        editor.apply();
        //send numCat
        ...
        Intent nextPage = new Intent(Categories.this, MainActivity.class);
